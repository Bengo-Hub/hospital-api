...
APP_NAME=${APP_NAME:-"hospital-api"}
NAMESPACE=${NAMESPACE:-"hospital"}
ENV_SECRET_NAME=${ENV_SECRET_NAME:-"hospital-api-secrets"}
DEPLOY=${DEPLOY:-true}
SETUP_DATABASES=${SETUP_DATABASES:-true}
DB_TYPES=${DB_TYPES:-postgres,redis}
# Per-service database configuration
SERVICE_DB_NAME=${SERVICE_DB_NAME:-hospital}
SERVICE_DB_USER=${SERVICE_DB_USER:-hospital_user}
...
GIT_USER=${GIT_USER:-"Hospital Bot"}
