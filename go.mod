module github.com/bengobox/hospital-service
...
require (
	github.com/Bengo-Hub/shared-events v0.6.1 // indirect
	github.com/Bengo-Hub/shared-service-client v0.3.1 // indirect
