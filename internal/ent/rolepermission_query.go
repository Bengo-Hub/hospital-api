...
type RolePermissionQuery struct {
	...
	withPermission *HospitalPermissionQuery
...
func (_q *RolePermissionQuery) QueryRole() *HospitalRoleQuery {
...
func (_q *RolePermissionQuery) QueryPermission() *HospitalPermissionQuery {
...
func (_q *RolePermissionQuery) WithRole(opts ...func(*HospitalRoleQuery)) *RolePermissionQuery {
	query := (&HospitalRoleClient{config: _q.config}).Query()
...
func (_q *RolePermissionQuery) WithPermission(opts ...func(*HospitalPermissionQuery)) *RolePermissionQuery {
	query := (&HospitalPermissionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *RolePermissionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*RolePermission, error) {
	...
	if query := _q.withRole; query != nil {
		if err := _q.loadRole(ctx, query, nodes, nil,
			func(n *RolePermission, e *HospitalRole) { n.Edges.Role = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withPermission; query != nil {
		if err := _q.loadPermission(ctx, query, nodes, nil,
			func(n *RolePermission, e *HospitalPermission) { n.Edges.Permission = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *RolePermissionQuery) loadRole(ctx context.Context, query *HospitalRoleQuery, nodes []*RolePermission, init func(*RolePermission), assign func(*RolePermission, *HospitalRole)) error {
...
func (_q *RolePermissionQuery) loadPermission(ctx context.Context, query *HospitalPermissionQuery, nodes []*RolePermission, init func(*RolePermission), assign func(*RolePermission, *HospitalPermission)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*RolePermission)
	for i := range nodes {
	...
	query.Where(hospitalpermission.IDIn(ids...))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	}
