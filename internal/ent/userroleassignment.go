...
type UserRoleAssignmentEdges struct {
	...
	User *HospitalUser `json:"user,omitempty"`
...
func (e UserRoleAssignmentEdges) UserOrErr() (*HospitalUser, error) {
	if e.User != nil {
		return e.User, nil
	} else if e.loadedTypes[0] {
		return nil, &NotFoundError{label: hospitaluser.Label}
	}
...
// was not loaded in eager-loading, or loaded but was not found.
func (e UserRoleAssignmentEdges) RoleOrErr() (*HospitalRole, error) {
	if e.Role != nil {
		return e.Role, nil
...
func (_m *UserRoleAssignment) QueryUser() *HospitalUserQuery {
...
func (_m *UserRoleAssignment) QueryRole() *HospitalRoleQuery {
