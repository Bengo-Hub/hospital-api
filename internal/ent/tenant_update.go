...
// AddUsers adds the "users" edges to the HospitalUser entity.
func (_u *TenantUpdate) AddUsers(v ...*HospitalUser) *TenantUpdate {
...
// ClearUsers clears all "users" edges to the HospitalUser entity.
func (_u *TenantUpdate) ClearUsers() *TenantUpdate {
	_u.mutation.ClearUsers()
	return _u
}

// RemoveUserIDs removes the "users" edge to HospitalUser entities by IDs.
func (_u *TenantUpdate) RemoveUserIDs(ids ...uuid.UUID) *TenantUpdate {
	_u.mutation.RemoveUserIDs(ids...)
	return _u
}

// RemoveUsers removes "users" edges to HospitalUser entities.
func (_u *TenantUpdate) RemoveUsers(v ...*HospitalUser) *TenantUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddUsers adds the "users" edges to the HospitalUser entity.
func (_u *TenantUpdateOne) AddUsers(v ...*HospitalUser) *TenantUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// RemoveUsers removes "users" edges to HospitalUser entities.
func (_u *TenantUpdateOne) RemoveUsers(v ...*HospitalUser) *TenantUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
