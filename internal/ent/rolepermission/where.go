...
func HasRoleWith(preds ...predicate.HospitalRole) predicate.RolePermission {
	return predicate.RolePermission(func(s *sql.Selector) {
		step := newRoleStep()
...
func HasPermissionWith(preds ...predicate.HospitalPermission) predicate.RolePermission {
	return predicate.RolePermission(func(s *sql.Selector) {
