...
func (_c *RolePermissionCreate) SetRole(v *HospitalRole) *RolePermissionCreate {
	return _c.SetRoleID(v.ID)
}

// SetPermission sets the "permission" edge to the HospitalPermission entity.
func (_c *RolePermissionCreate) SetPermission(v *HospitalPermission) *RolePermissionCreate {
