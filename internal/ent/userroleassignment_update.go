...
// SetUser sets the "user" edge to the HospitalUser entity.
func (_u *UserRoleAssignmentUpdate) SetUser(v *HospitalUser) *UserRoleAssignmentUpdate {
	return _u.SetUserID(v.ID)
}

// SetRole sets the "role" edge to the HospitalRole entity.
func (_u *UserRoleAssignmentUpdate) SetRole(v *HospitalRole) *UserRoleAssignmentUpdate {
	...
	if _u.mutation.UserCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(hospitaluser.FieldID, field.TypeUUID),
			},
		}
...
// SetUser sets the "user" edge to the HospitalUser entity.
func (_u *UserRoleAssignmentUpdateOne) SetUser(v *HospitalUser) *UserRoleAssignmentUpdateOne {
	return _u.SetUserID(v.ID)
}

// SetRole sets the "role" edge to the HospitalRole entity.
func (_u *UserRoleAssignmentUpdateOne) SetRole(v *HospitalRole) *UserRoleAssignmentUpdateOne {
	return _u.SetRoleID(v.ID)
}
