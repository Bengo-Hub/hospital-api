...
// OutboxEvent holds transactional outbox events. The column layout matches shared-events' SQL
// outbox repository exactly — do not add mixins/extra columns here. Ported from library-api's
// OutboxEvent, the platform's standard shape for this exact need.
