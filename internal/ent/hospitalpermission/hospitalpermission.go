...
const (
	// Label holds the string label denoting the hospitalpermission type in the database.
	...
	// Table holds the table name of the hospitalpermission in the database.
	Table = "hospital_permissions"
	// RolesTable is the table that holds the roles relation/edge. The primary key declared below.
	RolesTable = "role_permissions"
	// RolesInverseTable is the table name for the HospitalRole entity.
	// It exists in this package in order to avoid circular dependency with the "hospitalrole" package.
	RolesInverseTable = "hospital_roles"
...
// Columns holds all SQL columns for hospitalpermission fields.
var Columns = []string{
	FieldID,
	FieldPermissionCode,
	FieldName,
...
// OrderOption defines the ordering options for the HospitalPermission queries.
