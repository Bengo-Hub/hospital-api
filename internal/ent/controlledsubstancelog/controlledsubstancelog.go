...
var (
	...
	// QuantityDispensedValidator is a validator for the "quantity_dispensed" field. It is called by the builders before save.
	QuantityDispensedValidator func(float64) error
