...
type RolePermissionEdges struct {
	...
	Role *HospitalRole `json:"role,omitempty"`
	// Permission holds the value of the permission edge.
	Permission *HospitalPermission `json:"permission,omitempty"`
...
func (e RolePermissionEdges) RoleOrErr() (*HospitalRole, error) {
	if e.Role != nil {
		return e.Role, nil
	} else if e.loadedTypes[0] {
		return nil, &NotFoundError{label: hospitalrole.Label}
	}
...
// was not loaded in eager-loading, or loaded but was not found.
func (e RolePermissionEdges) PermissionOrErr() (*HospitalPermission, error) {
	if e.Permission != nil {
		return e.Permission, nil
	} else if e.loadedTypes[1] {
		return nil, &NotFoundError{label: hospitalpermission.Label}
	}
...
func (_m *RolePermission) QueryRole() *HospitalRoleQuery {
...
func (_m *RolePermission) QueryPermission() *HospitalPermissionQuery {
