...
// SetRole sets the "role" edge to the HospitalRole entity.
func (_u *RolePermissionUpdate) SetRole(v *HospitalRole) *RolePermissionUpdate {
	return _u.SetRoleID(v.ID)
}

// SetPermission sets the "permission" edge to the HospitalPermission entity.
func (_u *RolePermissionUpdate) SetPermission(v *HospitalPermission) *RolePermissionUpdate {
...
// SetRole sets the "role" edge to the HospitalRole entity.
func (_u *RolePermissionUpdateOne) SetRole(v *HospitalRole) *RolePermissionUpdateOne {
	return _u.SetRoleID(v.ID)
}

// SetPermission sets the "permission" edge to the HospitalPermission entity.
func (_u *RolePermissionUpdateOne) SetPermission(v *HospitalPermission) *RolePermissionUpdateOne {
	return _u.SetPermissionID(v.ID)
}
