...
const (
	// Label holds the string label denoting the hospitalrole type in the database.
	Label = "hospital_role"
	...
	// Table holds the table name of the hospitalrole in the database.
	Table = "hospital_roles"
	...
	// PermissionsInverseTable is the table name for the HospitalPermission entity.
	// It exists in this package in order to avoid circular dependency with the "hospitalpermission" package.
	PermissionsInverseTable = "hospital_permissions"
...
// OrderOption defines the ordering options for the HospitalRole queries.
