...
type Tenant struct {
	...
	// Primary business use case — synced from auth-api (e.g. hospital)
...
type TenantEdges struct {
	...
	Users []*HospitalUser `json:"users,omitempty"`
...
func (e TenantEdges) UsersOrErr() ([]*HospitalUser, error) {
	if e.loadedTypes[0] {
		return e.Users, nil
	}
...
func (_m *Tenant) QueryUsers() *HospitalUserQuery {
